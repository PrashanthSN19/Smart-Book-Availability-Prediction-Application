										...
										<div class="row gy-3 mb-2">
											...
											<div class="col-md-12 d-flex align-items-end gap-2">
												<label for="dated" class="form-label d-block text-nowrap">Search
													For:</label>
												<input type="text" placeholder="Enter content" runat="server" name="data"
										...
										<% Connection con=null; 
											...
											dbName, userName, password); System.out.println("Connected to the database"); 
                                                                                ...
                                                                                { 
                                                                                 ...
                                                                                 PreparedStatement st=con.prepareStatement("select Bid,Filname,BType,UploadedBy,Bname from filedata");
                                                                                res=st.executeQuery();
                                                                                while(res.next())
                                                                                {
                                                                                %>
                                                                                ...
                                                                                <div class="col-lg-4" style="padding:20px;">
                                                                                    <img src="./Files/<%=res.getString(2)%>" style="height:200px;" /><br/>
                                                                                    <h5>Book Id : <%=res.getString(1)%></h5>
                                                                                    <h5>Book Name : <%=res.getString(5)%></h5>
                                                                                    <h5>Book Type : <%=res.getString(3)%></h5>
                                                                                    <h5>Publisher : <%=res.getString(4)%></h5>
                                                                                    <h5><a href="viewdata.jsp?bid=<%=res.getString(1)%>">View Book Info </a></h5>
                                                                                </div>
                                                                                <% } 
                                                                                    }
                                                                                    if(fname!=null) 
{ 
                                                                                 ...
                                                                                 PreparedStatement st=con.prepareStatement("select Bid,Filname,BType,UploadedBy from filedata where Bname like '%"+fname+"%'");
                                                                                res=st.executeQuery();
                                                                                while(res.next())
                                                                                {
                                                                                %>
