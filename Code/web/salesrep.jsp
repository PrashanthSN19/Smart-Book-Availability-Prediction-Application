					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item">
								<a class="nav-link fs-5 "
									aria-current="page" href="merchantpage.jsp">Home</a>
							</li>
							<li class="nav-item">
								<a class="nav-link fs-5 active fw-bold text-decoration-underline link-offset-2" href="salesrep.jsp">Sales Report</a>
							</li>
							<li class="nav-item">
            ...
            response.sendRedirect("login.jsp");
										...
										ResultSet res=null; 
											...
											<table id="customers" class="table table-bordered">
												...
												<tbody>
												<% 
						PreparedStatement st=con.prepareStatement("select c.*,f.* from cartdata c Join filedata f on f.Bid=c.Bid");
						 res=st.executeQuery();
						 while(res.next())
						 {
						 %>
						 <tr>
						     ...
						     <td><%=res.getString(7)%></td>
                                                         ...
                                                         <td><img src="./Files/<%=res.getString(11)%>" style="height:150px;" /></td>
