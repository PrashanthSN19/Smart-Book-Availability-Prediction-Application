						...
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
							<li class="nav-item">
								<a class="nav-link fs-5 active fw-bold text-decoration-underline link-offset-2"
									aria-current="page" href="userpage.jsp">Home</a>
							</li>
							<li class="nav-item">
								<a class="nav-link fs-5" href="uploadfile.jsp">Upload Book</a>
							</li>
							<li class="nav-item">
									...
									<div class="card-body p-md-4 py-4 mx-md-4 mx-2">
										...
										<div class="row gx-4 gy-2">
											<div class="col-md-4 text-center">
												<img src="images/ca.png" style="width:250px;height:250px;"
													class="img-thumbnail img-fluid border-2 d-block" />
												<a href="uploadfile.jsp"
													class="text-dark text-decoration-none fw-bold fs-5"> Book Upload</a>
											</div>
											<div class="col-md-4 text-center">
												.
											</div>
