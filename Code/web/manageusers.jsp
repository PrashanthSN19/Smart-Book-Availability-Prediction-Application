            ...
            response.sendRedirect("login.jsp");
										...
										ResultSet res=null; 
											...
											<table id="customers" class="table table-bordered">
												...
												<tbody>
												<% 
						PreparedStatement st=con.prepareStatement("select Name,Uname,Email,Age,Gender,Phone from userdata where UStatus='Approved'");
						 res=st.executeQuery();
						 while(res.next())
						 {
						 %>
						 <tr>
						     ...
						     <td><a href=" deletedata.jsp?Uname=<%=res.getString(2)%>"   class="btn btn-sm btn-danger shadow-none">Delete User</a>
													</tr>
													<% 
												}
												 %>
