			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a class="nav-link fs-5 active fw-bold text-decoration-underline link-offset-2" href="managefiles.jsp">Manage Books</a>
						</li>
						<li class="nav-item">
...
<tbody>
 <%
     ...
     PreparedStatement st=con.prepareStatement("select Bid,Bname,BType,Filname from filedata");
 res=st.executeQuery();
 while(res.next())
 {
 %>
