				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
							...
							<li class="nav-item">
								<a class="nav-link fs-5" href="salesrep.jsp">Sales Report</a>
							</li>
							<li class="nav-item">
...
<tbody>
 <%
     ...
     PreparedStatement st=con.prepareStatement("select Bid,Bname,BType,Filname,Location from filedata");
 res=st.executeQuery();
 while(res.next())
 {
 %>
 <tr>
     ...
     <td><a href="https://www.google.com/maps/search/<%=res.getString(5)%>" target="_blank">View Location</a></td>
 </tr>
 <%
 }
 %>
