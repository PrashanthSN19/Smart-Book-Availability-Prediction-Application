            ...
            response.sendRedirect("login.jsp");
										...
										ResultSet res=null; 
											...
											<table id="customers" class="table table-bordered">
												...
												<tbody>
												<% 
						PreparedStatement st=con.prepareStatement("select c.*,f.* from cartdata c Join filedata f on f.Bid=c.Bid where c.Bookedby='"+uname+"'");
						 res=st.executeQuery();
						 while(res.next())
						 {
						 %>
						 <tr>
						     ...
						     <td><%=res.getString(4)%></td>
                                                     <td><a href="writereview.jsp?Bid=<%=res.getString(6)%>" class="btn btn-primary">Write Review</a></td>
													</tr>
													<% 
												}
												 %>
