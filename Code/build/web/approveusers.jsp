			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						<li class="nav-item">
							<a class="nav-link fs-5" aria-current="page" href="adminpage.jsp">Home</a>
						</li>
						<li class="nav-item">
						...
						<li class="nav-item">
							<a class="nav-link fs-5 active fw-bold text-decoration-underline link-offset-2 " href="approveusers.jsp">Approve Users</a>
						</li>
						<li class="nav-item">
...
<tbody>
 <%
     PreparedStatement st=con.prepareStatement("select Name,Uname,Email,Age,Gender,Phone from userdata where UStatus='Pending'");
 res=st.executeQuery();
 while(res.next())
 {
 %>
 <tr>
     ...
     <td><a href="approvedata.jsp?Uname=<%=res.getString(2)%>" class="btn btn-sm btn-primary shadow-none">Approve User</a>
 </tr>
 <%
 }
 %>
